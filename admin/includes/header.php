...
<head>
    ...
    <title><?= $pageTitle ?? 'Admin Panel' ?> - Login System</title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar text-white p-3" style="width: 250px;">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'lock-management.php' ? 'active' : '' ?>" 
                   href="lock-management.php">
                    <i class="bi bi-lock"></i> Lock Management
                </a>
                <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'activity-log.php' ? 'active' : '' ?>" 
        ...
        <div class="flex-grow-1 bg-light" style="min-height: 100vh;">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
                <div class="container-fluid">
                    <span class="navbar-brand mb-0 h1"><?= $pageTitle ?? 'Admin Panel' ?></span>
                    <div class="ms-auto">
